...
![serial]({{site.url}}/assets/Fritzing_imgs/testSerial_bb.png){: width="100%"}
...
![pd serial]({{site.url}}/assets/images/pd-serial.png){: width="100%"}
...
![pd moses]({{site.url}}//assets/images/pd-moses.png){: width="35%;"}
...
![pd netreceive]({{site.url}}//assets/images/pd-netreceive.png){: width="100%;"}
